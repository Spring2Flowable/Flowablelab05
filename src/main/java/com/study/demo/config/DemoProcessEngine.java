...
@Configuration
public class DemoProcessEngine {

    protected static final String LIQUIBASE_CHANGELOG_PREFIX = "ACT_DE_";
    private static final Logger LOGGER = LoggerFactory.getLogger(DemoProcessEngine.class);
    @Autowired
    ...
    @Primary
    @Bean // destroyMethod: see https://github.com/mybatis/old-google-code-issues/issues/778
